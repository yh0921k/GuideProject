...
public class ApplicationContext06 {
  ...
  public ApplicationContext06(String packageName, Map<String, Object> beans)
    ...
    // 클래스 이름으로 클래스를 로딩한다.
    // 객체 생성이 가능한 concrete 클래스를 별도의 목록으로 준비한다.
  ...
  private Object createInstance(Class<?> cls) throws ClassNotFoundException, InstantiationException,
    ...
    objPool.put(beanName == null ? cls.getName() : beanName, obj);
    return obj;
