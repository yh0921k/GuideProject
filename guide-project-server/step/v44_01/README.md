# 44_01 - UI 객체에서 Business Logic 분리하기

비즈니스 로직을 별도의 클래스로 분리하면, UI 구현 방식이 변경되더라도 비즈니스 로직을 재사용할 수 있다.
...
### 실습 1 : PhotoBoardXXXServlet에서 Business 로직을 분리한다.
...
### 실습 2 : BoardXxxServlet 에서 비즈니스 로직을 분리한다.
...
### 실습 3 : MemberXxxServlet 에서 비즈니스 로직을 분리한다.
...
### 실습 4 : LessonXxxServlet 에서 비즈니스 로직을 분리한다.
