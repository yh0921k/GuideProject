...
public class App {
  public static void main(String[] args) throws Exception { 
    ...
    BoardHandler boardHandler1 = new BoardHandler(br);
    BoardHandler boardHandler2 = new BoardHandler(br, 200);
    BoardHandler boardHandler3 = new BoardHandler(br, 1000);
    BoardHandler boardHandler4 = new BoardHandler(br);
    BoardHandler boardHandler5 = new BoardHandler(br, 9000);
    BoardHandler boardHandler6 = new BoardHandler(br, 20000);
