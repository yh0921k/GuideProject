...
public abstract class AbstractJsonFileDao<T> {
  ...
  protected void loadData() {
    ...
    try (BufferedReader in = new BufferedReader(new FileReader(file))) {
      ...
      // System.out.println("[Class<?> currType = this.getClass()] : " + currType);

      // generic type의 super class의 정보를 알아낸다.
      Type parentType = currType.getGenericSuperclass();
      // System.out.println("[Type parentType = currType.getGenericSuperclass()] : " + parentType);
      ...
      // System.out.println("[ParameterizedType parentType2 = (ParameterizedType) parentType] : " +
      // parentType2);
      ...
      // System.out.println("[Type[] params = parentType2.getActualTypeArguments()] : " + params);

      // 여기서 관심있는 것은 T 타입 정보이다.
      // 배열의 0번 인덱스에 존재한다.
      Type itemType = params[0];
      // System.out.println("[Type itemType = params[0]] : " + itemType);
